...
df = pd.read_csv('/home/lyli/NV-DVFS-Benchmark-master/tools/csvs/V100-5:5/merged_file_ratio_e2.csv')
df_test = pd.read_csv('/home/lyli/NV-DVFS-Benchmark-master/tools/csvs/raw/task_3/merged_file.csv')
