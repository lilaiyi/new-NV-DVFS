...
df = pd.read_csv('/home/lyli/NV-DVFS-Benchmark-master/tools/csvs/raw/task_3/merged_file_3.csv')



x=standardScaler.fit_transform(df[['coreF','SMACT','SMOCC','DRAMA','FP32A',
        'SMACT_single_2','SMOCC_single_2',
        'DRAMA_single_2','FP32A_single_2']])
...
joblib.dump(model_power, 'model_power_3.pkl')
...
joblib.dump(model_per, 'model_per_3.pkl')