...
logRoot = '/home/lyli/NV-DVFS-Benchmark-master/logs/single_tasks/%s-%s' %( gpucard, version)
...
for fp in perf_filelist:
    ...
    recs.append(rec)
# prepare csv file
csvfile = open('csvs/raw/single/%s-%s-Performance.csv' % (gpucard, version), 'w')
...
for fp in power_filelist:
    ...
    recs.append(rec)
# prepare csv file
csvfile = open('csvs/raw/single/%s-%s-POWER.csv' % (gpucard, version), 'w')
csvWriter = csv.writer(csvfile, dialect='excel')
# write table head
csvWriter.writerow(head)
# write records
...
for fp in dcgm_filelist:
    ...
    recs.append(rec)
# prepare csv file
csvfile = open('csvs/raw/single/%s-%s-dcgm.csv' % (gpucard, version), 'w')
csvWriter = csv.writer(csvfile, dialect='excel')
# write table head
csvWriter.writerow(head)
# write records
